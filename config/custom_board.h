...
// LEDs definitions for SensorWeb
...
#define BSP_LED_1_MASK BSP_LED_0_MASK // bsp.c wants BSP_LED_1_MASK

#define LEDS_MASK      (BSP_LED_0_MASK)
/* Our LED is lit up when the LED is high */
#define LEDS_INV_MASK  0

#define BUTTONS_NUMBER 0

#if 0  
#define RX_PIN_NUMBER  11 // pca10028 pin numbers
#define TX_PIN_NUMBER  9
#else
#define RX_PIN_NUMBER  4
#define TX_PIN_NUMBER  5
#endif
#define CTS_PIN_NUMBER 6  // not used (flow control is disabled)
#define RTS_PIN_NUMBER 7  // not used (flow control is disabled)
#define HWFC           false
